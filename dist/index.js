...
__nccwpck_require__.d(__webpack_exports__, {
  "parseAllRedirects": () => (/* reexport */ parseAllRedirects)
});
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/node_modules/path-exists/index.js
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/results.js
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/status.js
...
// and ignores it.
const transtypeStatusCode = function (status) {
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/url.js
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/line_parser.js
...
const readRedirectFile = async function (redirectFile) {
    try {
        return await external_fs_.promises.readFile(redirectFile, 'utf8');
    }
    catch {
...
var fast_safe_stringify = __nccwpck_require__(676);
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/merge.js
...
const removeDuplicates = function (redirects) {
    ...
    for (let i = redirects.length - 1; i >= 0; i--) {
        const r = redirects[i];
        const key = fast_safe_stringify["default"].stableStringify(r);
...
var toml = __nccwpck_require__(920);
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/netlify_config_parser.js
...
const parseConfig = async function (configPath) {
    try {
        const configString = await external_fs_.promises.readFile(configPath, 'utf8');
        const config = (0,toml.parse)(configString);
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/conditions.js
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/normalize.js
...
const normalizeRedirects = function (redirects, minimal) {
    if (!Array.isArray(redirects)) {
        const error = new TypeError(`Redirects must be an array not: ${redirects}`);
        return splitResults([error]);
    }
    const results = redirects.map((obj, index) => normalize_parseRedirect(obj, index, minimal));
    return splitResults(results);
};
const normalize_parseRedirect = function (obj, index, minimal) {
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/all.js
...
const parseAllRedirects = async function ({ redirectsFiles = [], netlifyConfigPath, configRedirects = [], minimal = false, }) {
...
;// CONCATENATED MODULE: ./node_modules/netlify-redirect-parser/lib/index.js
...
(() => {
const { parseAllRedirects } = __nccwpck_require__(649);
